...
ReporteFinPartidoView = function () {
    ...
    function renderChart(cuartos) {
        ...
        var visitanteData = [0];
        var localGameData = [0];
        var visitaneGameData = [0];
        $.each(cuartos, function (idx, cuarto) {
           
        
       
        	localGameData.push(cuarto.resultadoLocal);
        	visitaneGameData.push(cuarto.resultadoVisitante);
      ...
      //new chart type LineBar - its a bit like bar and line were slammed together at high speed, not pretty, but they are part of each other now
        ...
        var data2 = {
            ...
            datasets: [{
                ...
                data: visitanteGameData
            },{
                label: "Visita Cuartos",
                //new option, barline will default to bar as that what is used to create the scale
                type: "bar",
                fillColor: "rgba(151,187,205,0.0)",
                strokeColor: "rgba(151,187,205,1)",
        ...
        //charts
        //var myLineChart = new Chart(line).Line(data);
        //var myBarChart = new Chart(bar).Bar(data);
        //var myLineBarChart = new Chart(lineBar).LineBar(data);

        //testing to make sure we can add more than 1 of each
        var myMultiLineBarChart = new Chart(multiLineBar).LineBar(data2);
