...
public class EventoController {
	...
	public @ResponseBody ResponseMessage eventoLanzamientoJSON(@RequestBody EventoLanzamientoData evtLanzamientoData){
		String code = "-1";
	...
	public @ResponseBody ResponseMessage eventoLanzamiento(){
